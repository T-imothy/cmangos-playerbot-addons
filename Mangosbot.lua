...
function SendBotCommand(text, chat, lang, channel)
    ...
    if (chat == "SAY") then
        ...
        -- TBC 2.4.3 supports the addon-message transport used by the
        -- existing working CMaNGOS TBC Mangosbot addon, including WHISPER.
...
CMaNGOSAdvancedPartyBots = function()
    ...
    if GetNumRaidMembers and GetNumRaidMembers() > 0 then
        ...
        -- In a five-player TBC party, the player is `player` and the
...
local CMaNGOSHelpPages = {
    {
        ...
        text =
            ...
            "Mangosbot is a visual controller for CMaNGOS TBC PlayerBot commands. It does not replace the bot AI; it gives you faster access to commands and strategies already supported by your server.\n\n|cffffcc00TBC expansion support|r\nThe TBC PlayerBot core adds Arena and Eye of the Storm behavior beyond the Classic battleground set. Those encounter/BG strategies are handled by the bot AI; you do not need separate addon buttons to enable normal Arena or Eye of the Storm participation.\n\n" ..
    ...
    },
    {
        ...
        text =
            ...
            "RPG modes include general NPC interaction plus Quest, Vendor, Explore, Maintenance, Player, Craft and Battleground behavior.\n\n|cffffcc00TBC PvP|r\nIn addition to Warsong Gulch, Arathi Basin and Alterac Valley, the TBC core includes Eye of the Storm and Arena bot behavior.\n\n" ..
...
function CreateMangosbotHelpWindow()
    ...
    local subtitle = f:CreateFontString(nil, "OVERLAY", "GameFontNormalSmall")
    subtitle:SetPoint("TOPLEFT", title, "BOTTOMLEFT", 0, -3)
    subtitle:SetText("|cff9ca9bdCMaNGOS TBC PlayerBot Manager  |  Designed by Tim|r")
