# CMaNGOS PlayerBot Addon — The Burning Crusade

Enhanced PlayerBot / MangosBot addon for **CMaNGOS TBC (WoW 2.4.3)**.
...
> **This branch is for The Burning Crusade (2.4.3).**
>
...
1. Download the addon from the `tbc` branch.
...
Do not use this branch with the Classic 1.12.1 or WotLK 3.3.5a clients. Use the appropriate repository branch instead.
