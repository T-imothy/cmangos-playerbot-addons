...
This package is a redesigned CMaNGOS TBC PlayerBot controller.
...
v8.6.10-TBC.2 HELP / CHARACTER + CLASS NOTES
...
- Random Gear is the supported gear-generation action on this CMaNGOS TBC build. Upgrade Gear is not supported and has been removed.


TBC EXPANSION NOTES
- TBC PlayerBots retain the shared Classic controls exposed by Mangosbot.
- TBC additionally includes native Eye of the Storm and Arena behavior in the PlayerBot core.
- These PvP behaviors are handled primarily by the bot AI and do not require separate addon buttons for normal participation.
